...
| --------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **IAF / MAX tabs** (per unit)     | via `resolveRangeByUnit`      | [`src/lib/components/PressureRangeTab.svelte`](../src/lib/components/PressureRangeTab.svelte) (resolver: [`range-resolve.ts`](../data-repo/lib/pressure/range-resolve.ts))           |
