<script lang="ts">
	import type { FieldDef, SortStep } from '$data/lib/pipeline/index.js';
...
<div class="step">
	...
	<div class="step-controls">
		...
		<select value={step.direction} onchange={(e) => { step.direction = (e.target as HTMLSelectElement).value as 'asc' | 'desc'; onchange(); }}>
