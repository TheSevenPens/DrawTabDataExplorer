...
export const TEMPLATE_GROUPS: { group: string; labels: string[] }[] = [
	...
	},
	{
		...
		labels: ['High digitizer density tablets', 'Tablets missing release year'],
	},
	{
		...
		labels: [
			...
			'Release year between 2018–2022 → count per brand',
...
export const BASIC_TEMPLATES: QueryBuilderTemplate[] = [
	{
		...
		columns: ['Brand', 'ModelId', 'ModelName', 'ModelReleaseYear', 'ModelType'],
		take: 5,
		output: { mode: 'toArray' },
	},
	{
		...
		sorts: [],
		columns: ['FullName', 'ModelId', 'Brand', 'ModelReleaseYear'],
		take: 1,
		output: { mode: 'toArray' },
	},
	{
		...
		sorts: [{ field: 'ModelReleaseYear', direction: 'desc' }],
		columns: ['Brand', 'ModelId', 'ModelName', 'ModelReleaseYear'],
		take: 5,
		output: { mode: 'toArray' },
	},
	{
	...
	},
	{
		...
		collection: 'Tablets',
		filters: [{ field: 'ModelReleaseYear', operator: '>=', value: '2020' }],
		sorts: [{ field: 'ModelReleaseYear', direction: 'desc' }],
		columns: ['Brand', 'ModelId', 'ModelName', 'ModelReleaseYear'],
		output: { mode: 'toArray' },
	},
	{
		...
		sorts: [{ field: 'ModelReleaseYear', direction: 'desc' }],
		columns: ['Brand', 'ModelId', 'ModelName', 'ModelAudience', 'ModelReleaseYear'],
		output: { mode: 'toArray' },
	},
	{
	...
	{
		label: 'Tablets missing release year',
		collection: 'Tablets',
		filters: [{ field: 'ModelReleaseYear', operator: 'empty', value: '' }],
	...
	{
		label: 'Release year between 2018–2022 → count per brand',
		collection: 'Tablets',
		filters: [{ field: 'ModelReleaseYear', operator: 'between', value: '2018|2022' }],
	...
	},
	{
		...
		sorts: [],
		columns: ['FullName', 'PenId', 'Brand', 'ReleaseYear'],
		take: 1,
		output: { mode: 'toArray' },
	},
	{
		...
		collection: 'Pens',
		filters: [{ field: 'Brand', operator: '==', value: 'WACOM' }],
		sorts: [{ field: 'ReleaseYear', direction: 'desc' }],
		columns: ['Brand', 'PenId', 'PenName', 'ReleaseYear'],
		take: 15,
		output: { mode: 'toArray' },
	},
	{
